...
This dataset has `r nrow(usgs)` smpling site.

```{r plot, echo=TRUE}
plot(faithful, main= "Do I wait longer for longer eruptin?")
...
repository.
3- A data policy and stewardship plan will be established. In
